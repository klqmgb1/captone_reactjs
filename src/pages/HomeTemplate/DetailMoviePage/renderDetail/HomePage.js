...
import { apiTheater, apiTheaterDetailShowing, filmApi } from './../../DEMO/apiHome';
                ...
                <div className="container mt-2 ">
                    <div className='row '>
                        <div className='col-md-2 p-sm-0 ' >
                            ...
                            <div className="row container " style={{ maxHeight: '110vh', overflow: 'auto ' }}>
                                {renderTheater()}
                            </div>
                        </div>
                        <div className='col-md-10'>
                            ...
                            <div className="row" >
                                <div className='col-md-4' style={{ maxHeight: '110vh', overflow: 'auto  ' }}>
                                    {renderTheaterDetail()}
                                </div>
                                <div ref={refToScroll} className='col-md-8' style={{ maxHeight: '110vh', overflow: 'auto  ' }}>
                                    {renderFilmOnTheater()}
                                </div>
                            </div>
                        </div>
